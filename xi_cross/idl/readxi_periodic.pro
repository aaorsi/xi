...
;
	...
	DataDir = '/home/aaorsi/work/AGNOverdensities/data/'

	vol = 500.0^3
	Binary = 0

	CentralModName = '_Fan14_full'
;	ModName = '_Fan14.e2'
	ModName = '_Fan14.e2'
	zsp     = '_zspace'
;	zsp     = ''
...
;	GalFile1 = 'radio_cat_iz'+snap
	GalFile1 = PData+'_cat_iz'+snap+CentralModName+zsp

	GalName = RT ? 'lyalphaShell' : 'lyalphaNoRT'

	; Comment this for Ly-alpha
	GalName = 'halpha'
...
;	Name = 'cc_radio_lyalphaShell_iz'+snap+'_'+lum[il]
	...
	Name = 'cc_'+PData+'_'+GalName+'_iz'+snap+ModName+'_'+lum[il]+zsp
	GalFile2 = GalName+'_cat_iz'+snap+ModName+'_lha'+lum[il]+zsp
...
;	print,bin
;	for jj = 0l,n_elements(r)-1 do binarr[jj] = bin
